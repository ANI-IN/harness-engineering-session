...
Violations can be reported by opening a GitHub issue marked "conduct" or by
contacting the maintainer through their GitHub profile
([@ANI-IN](https://github.com/ANI-IN)). Reports are handled confidentially.
Maintainers may edit or remove contributions that violate this code and may
