# Lecture 06: Why agents overreach and under-finish
...
- [Lecture 03](../lecture-03-why-the-repository-must-become-the-system-of-record/):
  the feature list as state that lives in the repository and so survives
  a session; this lecture reads it as the scope surface.
...
<!-- fence-exit: 1 -->
```sh
L=lectures/lecture-06-why-agents-overreach-and-under-finish
...
<!-- generated-block: uv run python lectures/lecture-06-why-agents-overreach-and-under-finish/code/python/main.py lectures/lecture-06-why-agents-overreach-and-under-finish/code/fixtures/workspaces/open-scope lectures/lecture-06-why-agents-overreach-and-under-finish/code/fixtures/session-script.json || true -->
```json
{
...
<!-- generated-block: uv run python lectures/lecture-06-why-agents-overreach-and-under-finish/code/python/main.py lectures/lecture-06-why-agents-overreach-and-under-finish/code/fixtures/workspaces/bounded-scope lectures/lecture-06-why-agents-overreach-and-under-finish/code/fixtures/session-script.json -->
```json
{
...
- **Park, do not argue.** A gate that only refuses trains the model (and
  ...
  as lecture 05's advice tier. Parking costs zero steps and keeps the
  provocation, so the refused idea is deferred rather than lost, and the
  queue doubles as the handoff lecture 11 asks for.
