...
// The signal the stopping condition reads for one round. The maker takes
// the step and reports on it, so its report is the earliest signal
// available that the work is finished.
