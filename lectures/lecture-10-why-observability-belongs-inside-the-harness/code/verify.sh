#!/usr/bin/env bash
# why-observability-belongs-inside-the-harness demo verify: runs this unit through the conformance runner.
...
echo "verify(lecture-11 resume-trace demo): stack=${STACK}"
