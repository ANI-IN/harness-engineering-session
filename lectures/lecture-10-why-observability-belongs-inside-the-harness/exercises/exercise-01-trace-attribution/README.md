...
[Lecture 10](../../README.md)'s claim is that the overwritten value
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-10-why-observability-belongs-inside-the-harness/exercises/exercise-01-trace-attribution -->
```text
