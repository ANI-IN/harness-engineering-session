...
[Lecture 08](../../README.md)'s demo showed a session skipping its
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-08-why-agents-declare-victory-too-early/exercises/exercise-02-layered-gate -->
```text
