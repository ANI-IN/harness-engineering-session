...
[Lecture 08](../../README.md)'s claim is that a completion declaration
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-08-why-agents-declare-victory-too-early/exercises/exercise-01-claim-audit -->
```text
