...
[Lecture 10](../../README.md) ends with a failing end-to-end run and a
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-10-why-end-to-end-testing-changes-results/exercises/exercise-02-seam-remediation -->
```text
