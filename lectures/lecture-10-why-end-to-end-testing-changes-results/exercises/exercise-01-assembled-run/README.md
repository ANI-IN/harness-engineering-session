...
[Lecture 10](../../README.md)'s claim is that the kind of check decides the
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-10-why-end-to-end-testing-changes-results/exercises/exercise-01-assembled-run -->
```text
