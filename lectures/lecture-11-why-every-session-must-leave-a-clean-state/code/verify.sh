#!/usr/bin/env bash
# why-every-session-must-leave-a-clean-state demo verify: runs this unit through the conformance runner.
...
echo "verify(lecture-11 session-ending demo): stack=${STACK}"
