...
// cancelled, a retry re-enters it. Each step reports whether it changed
// anything, and a pass in which nothing changed is `already-clean`.
//
...
// Add this session's entry to claude-progress.md.
//
// A progress log is append-only: the newest session goes on top of the
// previous one.
