...
NAME="exercise-02-idempotent-cleanup"
TASK_HINT="reconcile the progress entry instead of appending it, so re-entering the protocol cannot record the same session twice"
