...
[Lecture 11](../../README.md)'s dirty ending leaves a half applied
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-11-why-every-session-must-leave-a-clean-state/exercises/exercise-01-rollback-or-finish -->
```text
