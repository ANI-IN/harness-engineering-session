...
| --- | --- | --- | --- |
| 01 | Why capable agents still fail | Failures are harness defects, not capability defects | Project 01 |
| 02 | What a harness actually is | A harness is five subsystems working as one system | Project 01 |
