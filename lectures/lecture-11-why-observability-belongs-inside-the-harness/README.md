...
- [Lecture 05](../lecture-05-why-long-running-tasks-lose-continuity/):
  the session boundary as a data-loss event, and the continuity
  artifacts that survive it; this lecture is about the artifact the
  harness writes rather than the ones the session writes.
...
```sh
L=lectures/lecture-11-why-observability-belongs-inside-the-harness
...
<!-- generated-block: uv run python lectures/lecture-11-why-observability-belongs-inside-the-harness/code/python/main.py build lectures/lecture-11-why-observability-belongs-inside-the-harness/code/fixtures/workspaces/workspace-ingest --observability=none -->
```json
{
...
<!-- generated-block: uv run python lectures/lecture-11-why-observability-belongs-inside-the-harness/code/python/main.py resume lectures/lecture-11-why-observability-belongs-inside-the-harness/code/fixtures/workspaces/workspace-ingest --observability=none || true -->
```json
{
  "workspace": "workspace-ingest",
  "observability": "none",
...
<!-- generated-block: uv run python lectures/lecture-11-why-observability-belongs-inside-the-harness/code/python/main.py resume lectures/lecture-11-why-observability-belongs-inside-the-harness/code/fixtures/workspaces/workspace-ingest --observability=structured -->
```json
{
  "workspace": "workspace-ingest",
...
<!-- generated-block: diff lectures/lecture-11-why-observability-belongs-inside-the-harness/code/expected/resume-silent.json lectures/lecture-11-why-observability-belongs-inside-the-harness/code/expected/resume-instrumented.json || true -->
```text
3c3
<   "observability": "none",
---
...
<!-- generated-block: uv run python lectures/lecture-11-why-observability-belongs-inside-the-harness/code/python/main.py build lectures/lecture-11-why-observability-belongs-inside-the-harness/code/fixtures/workspaces/workspace-ingest --observability=structured | uv run python -c "import json,sys; [print(json.dumps(event, separators=(',', ':'))) for event in json.load(sys.stdin)['handoff']['events']]" -->
```text
