...
[Lecture 11](../../README.md)'s resume session works because one field in
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-11-why-observability-belongs-inside-the-harness/exercises/exercise-02-write-the-trace -->
```text
