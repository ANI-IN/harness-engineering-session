...
[Lecture 12](../../README.md)'s demo changes one thing between two runs,
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-12-loop-engineering/exercises/exercise-01-stopping-condition -->
```text
