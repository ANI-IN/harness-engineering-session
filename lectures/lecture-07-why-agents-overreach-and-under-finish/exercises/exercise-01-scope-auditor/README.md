...
[Lecture 07](../../README.md)'s claim is that overreach is a state you
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-07-why-agents-overreach-and-under-finish/exercises/exercise-01-scope-auditor -->
```text
