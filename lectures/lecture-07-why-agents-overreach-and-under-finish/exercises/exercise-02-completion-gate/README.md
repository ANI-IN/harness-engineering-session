...
[Lecture 07](../../README.md)'s under-finish is a feature that looks done
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-07-why-agents-overreach-and-under-finish/exercises/exercise-02-completion-gate -->
```text
