...
- [Lecture 05](../lecture-05-why-long-running-tasks-lose-continuity/):
  the continuity artifacts and what each one carries. That lecture is
  about their content; this one is about the moment they are written, and
  what the next session does when they are not.
...
<!-- fence-exit: 1 -->
```sh
L=lectures/lecture-12-why-every-session-must-leave-a-clean-state
...
<!-- generated-block: uv run python lectures/lecture-12-why-every-session-must-leave-a-clean-state/code/python/main.py resume lectures/lecture-12-why-every-session-must-leave-a-clean-state/code/fixtures/workspace --exit=dirty || true -->
```json
{
  "workspace": "workspace",
