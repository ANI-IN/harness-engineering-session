...
[Lecture 12](../../README.md)'s dirty ending produces by a different
route.
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-12-why-every-session-must-leave-a-clean-state/exercises/exercise-02-idempotent-cleanup -->
```text
