...
[Lecture 08](../../README.md)'s claim is that a feature list is a
...
command that was matched, the same way the lecture 06 doctor's pass
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-08-why-feature-lists-are-harness-primitives/exercises/exercise-01-pass-gate -->
```text
