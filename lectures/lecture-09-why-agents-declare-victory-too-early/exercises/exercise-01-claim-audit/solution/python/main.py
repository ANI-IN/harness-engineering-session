"""claim-audit exercise, Python solution.
...
def audit(workspace: Path, claim: dict) -> dict:
    ...
    for claimed in claim["checks"]:
        ...
        # Every claimed check is re-executed, executed-basis rows included:
        # a recorded pass is a statement about the past, and the workspace
