...
[Lecture 05](../../README.md)'s claim is that initialization is a phase
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-05-why-initialization-needs-its-own-phase/exercises/exercise-01-init-doctor -->
```text
