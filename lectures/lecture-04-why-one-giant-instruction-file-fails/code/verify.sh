#!/usr/bin/env bash
# why-one-giant-instruction-file-fails demo verify: runs this unit through the conformance runner.
...
echo "verify(lecture-04 instruction-stats demo): stack=${STACK}"
