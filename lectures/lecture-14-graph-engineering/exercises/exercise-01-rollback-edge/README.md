...
actually take the workspace back. [Lecture 14](../../README.md)'s demo
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-14-graph-engineering/exercises/exercise-01-rollback-edge -->
```text
