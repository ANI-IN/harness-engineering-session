...
[Lecture 06](../../README.md) makes initialization a gate, and gates need
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-06-why-initialization-needs-its-own-phase/exercises/exercise-02-readiness-gate -->
```text
