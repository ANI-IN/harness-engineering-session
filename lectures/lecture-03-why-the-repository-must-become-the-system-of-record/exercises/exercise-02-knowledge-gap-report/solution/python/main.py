"""knowledge-gap-report exercise, Python solution.

Computes the knowledge visibility gap from an inventory of project
decisions: which live in the repository (location starts with "repo:") and
which live somewhere an agent cannot see.
"""
...
def in_repo(location: str) -> bool:
    ...
    merely mentions repositories (a Confluence page about repo guidelines, a
    Slack channel named #repo-help) is still invisible."""
