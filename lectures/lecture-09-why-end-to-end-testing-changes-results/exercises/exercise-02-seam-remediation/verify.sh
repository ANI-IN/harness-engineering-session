...
NAME="exercise-02-seam-remediation"
TASK_HINT="address the fix instruction to the component that produced the offending value, not to the one that objected"
