# Lecture 09: Why end-to-end testing changes results
...
- [Lecture 06](../lecture-06-why-agents-overreach-and-under-finish/): the
...
<!-- generated-block: uv run python lectures/lecture-09-why-end-to-end-testing-changes-results/code/python/main.py coverage lectures/lecture-09-why-end-to-end-testing-changes-results/code/fixtures/workspaces/workspace-seam-gap -->
```json
{
  "workspace": "workspace-seam-gap",
  "components": [
