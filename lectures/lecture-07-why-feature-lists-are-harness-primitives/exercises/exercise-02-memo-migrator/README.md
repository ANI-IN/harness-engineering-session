...
[Lecture 07](../../README.md)'s demo shows a session ending on a false
...
<!-- generated-block: uv run python tools/run_acceptance.py lectures/lecture-07-why-feature-lists-are-harness-primitives/exercises/exercise-02-memo-migrator -->
```text
