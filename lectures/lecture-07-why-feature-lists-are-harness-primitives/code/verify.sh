#!/usr/bin/env bash
# why-feature-lists-are-harness-primitives demo verify: runs this unit through the conformance runner.
...
echo "verify(lecture-07 scope-replay demo): stack=${STACK}"
