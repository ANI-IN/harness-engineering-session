# Lecture 07: Why feature lists are harness primitives
...
- [Lecture 03](../lecture-03-why-the-repository-must-become-the-system-of-record/):
  state that is not in the repository does not exist for the agent, and
  the feature list is where that state takes its shape.
...
<!-- fence-exit: 1 -->
```sh
L=lectures/lecture-07-why-feature-lists-are-harness-primitives
...
<!-- generated-block: uv run python lectures/lecture-07-why-feature-lists-are-harness-primitives/code/python/main.py replay lectures/lecture-07-why-feature-lists-are-harness-primitives/code/fixtures/workspaces/workspace-memo || true -->
```json
{
...
<!-- generated-block: uv run python lectures/lecture-07-why-feature-lists-are-harness-primitives/code/python/main.py plan lectures/lecture-07-why-feature-lists-are-harness-primitives/code/fixtures/workspaces/workspace-memo || true -->
```json
{
  "workspace": "workspace-memo",
  "tracker": "notes.md",
