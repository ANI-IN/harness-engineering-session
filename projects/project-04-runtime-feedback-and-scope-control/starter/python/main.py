"""kb v3, project 04 Python starter.
...
surface, corrupt-index detection and rebuild, the behavioral architecture
guard, and the WIP limit in the workspace doctor. Run ./verify.sh until
the solution-stage cases pass against your changes.
"""
