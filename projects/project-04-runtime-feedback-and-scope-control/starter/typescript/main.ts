// kb v3, project 04 TypeScript starter.
//
// This is project 03's solution app, the state a new session inherits.
// Project 04's work is the delta in SPEC.md: structured logging, the logs
// surface, corrupt-index detection and rebuild, the behavioral
// architecture guard, and the WIP limit in the workspace doctor. Run
// ./verify.sh until the solution-stage cases pass against your changes.
