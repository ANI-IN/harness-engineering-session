// kb v2: agent-readable workspace, TypeScript track.
//
// Project 02's delta over project 01 (see SPEC.md "Delta from project 01"):
// import, a detail view, metadata persistence (the metadata index becomes
// the system of record for listing), a document-detail HTTP endpoint, and
// `workspace-check`, the workspace-readability doctor. The project 01
// experiment apparatus stays in project 01.
