...
| [03: Why the repository must become the system of record](lectures/lecture-03-why-the-repository-must-become-the-system-of-record/) | If it is not in the repository, it does not exist for the agent | [Project 02](projects/project-02-agent-readable-workspace/) |
...
| [05: Why initialization needs its own phase](lectures/lecture-05-why-initialization-needs-its-own-phase/) | init.sh as a first-class phase, gated by a doctor | [Project 03](projects/project-03-multi-session-continuity/) |
| [06: Why agents overreach and under-finish](lectures/lecture-06-why-agents-overreach-and-under-finish/) | WIP=1 read from the workspace; a parked queue instead of a refusal | [Project 04](projects/project-04-runtime-feedback-and-scope-control/) |
| [07: Why feature lists are harness primitives](lectures/lecture-07-why-feature-lists-are-harness-primitives/) | The triple (behavior, command, status); passing only through the command | [Project 04](projects/project-04-runtime-feedback-and-scope-control/) |
| [08: Why agents declare victory too early](lectures/lecture-08-why-agents-declare-victory-too-early/) | Re-execution, not review, separates an earned claim from a premature one | [Project 05](projects/project-05-self-verification-and-role-separation/) |
| [09: Why end-to-end testing changes results](lectures/lecture-09-why-end-to-end-testing-changes-results/) | The definition of done decides the result: seams are only exercised assembled | [Project 05](projects/project-05-self-verification-and-role-separation/) |
| [10: Why observability belongs inside the harness](lectures/lecture-10-why-observability-belongs-inside-the-harness/) | The harness records what the session did, so the next session can repair rather than guess | Closest: [Project 04](projects/project-04-runtime-feedback-and-scope-control/) |
| [11: Why every session must leave a clean state](lectures/lecture-11-why-every-session-must-leave-a-clean-state/) | Continuity artifacts and the exit protocol: verify, roll back, record, hand off | Closest: [Project 03](projects/project-03-multi-session-continuity/), [Project 05](projects/project-05-self-verification-and-role-separation/) |
| [12: Loop engineering](lectures/lecture-12-loop-engineering/) | Goal file, loop state, maker and checker, a stopping condition wired to the right signal | None |
| [13: Graph engineering](lectures/lecture-13-graph-engineering/) | Nodes, edges, shared state, a router, and one rollback edge, in the standard library | None |
