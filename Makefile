...
.PHONY: help setup doctor resume status quick verify verify-dedup conformance lint lint-py lint-ts lint-md lint-sh lint-prose lint-links lint-links-external lint-mermaid lint-structure lint-shared-helpers lint-authorship check-fresh
...
lint-authorship: ## No co-author trailers or tool attributions in commit bodies
	@uv run python tools/lint/check_commit_authorship.py
